...
WordPress theme for **Hashbox Studio** (hashbox.co.th) — a creative agency landing page. This is a classic WordPress theme (not a block theme), deployed via Git to a shared hosting environment.

- **Production**: https://hashbox.co.th
- **Deploy path**: `/httpdocs/wp-content/themes/hashbox-studio/`
- **Deploy method**: Push to `main` branch (auto-deploy configured)
...
- The theme text domain is `hashbox-studio`
